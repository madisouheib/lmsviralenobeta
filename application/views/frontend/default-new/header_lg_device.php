   ...
   <i class="fas fa-list" style=" vertical-align: middle;"></i>
      ...
      <?php endif; ?>
        ...
        <!-- Cart List Area -->
          ...
          <a href="<?php echo site_url('sign_up'); ?>" style="border: 2px solid #1e293b ; color:#1e293b; border-radius:10px;font-weight:500;font-size: 16px; padding:10px;" class="mx-2 text-capitalize"> سجل الآن</a>
        <?php endif; ?>
