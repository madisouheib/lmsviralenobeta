    ...
    <div class="offcanves-top">
      <?php if($user_id > 0): ?>
        <div class="offcanves-profile">
          <a href="#">
            <div class="user-img">
              <img src="<?php echo site_url('assets/frontend/default-new/') ?>image/placeholder.png" alt="img" />
            </div>
      ...
      <div class="flex-shrink-0 mt-3">
        <ul class="list-unstyled ps-0">
          <?php if($user_login): ?>
            ...
            <?php else: ?>
              <li><a href="<?php echo site_url('home/become_an_instructor'); ?>" class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-16px fw-500"><i class="fas fa-columns me-2"></i><?php echo site_phrase('Become a instructor'); ?></a></li>
            <?php endif; ?>
          <?php endif; ?>
          ...
          <li class="bg-light">
            ...
            <div class="collapse" id="category-collapse">
              <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small bg-white">
                ...
                <?php endforeach; ?>
                <li>
                  <a href="" class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-15px fw-400"> <i class="fas fa-list me-2"></i> <?php echo get_phrase('All Courses'); ?></a>
                </li>
              </ul>
            </div>
          </li>
