...
<section class="courses grid-view-body pt-60">
    <div class="container">
                                ...
                                <div class="courses-price-border">
                                    <div class="courses-price">
                                        ...
                                        <div class="courses-price-right ">
                                            <p class="m-0"><i class="fa-regular fa-clock text-15px pe-0"></i> <?php echo $course_duration; ?></p>
                                        </div>
                                    </div>
                                </div>
                             </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="h-2-instructor-full">
                                <div class="h-2-instructor-image">
                                    <img src="<?php echo $this->user_model->get_user_image_url($top_instructor['id']); ?>" alt="">
                                    <div class="icon">
