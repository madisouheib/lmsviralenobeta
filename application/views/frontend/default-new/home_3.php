        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 bannar-hide">
                <div class="h-3-banner-image pt-5">
                    <img src="<?php echo base_url("uploads/system/" . get_current_banner('banner_image')); ?>" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6 sidebar-arrow">
                <div class="h3-banner-card-1">
                    <img src="<?php echo site_url('assets/frontend/default-new/'); ?>image/analysis.png" alt="">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 sidebar-arrow">
                <div class="h3-banner-card-1">
                    <img src="<?php echo site_url('assets/frontend/default-new/'); ?>image/ebook.png" alt="">
                    <div class="h3-banner-card-1-text">
                        <h5>
                            <a href="#">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 sidebar-arrow">
                <div class="h3-banner-card-1">
                    <img src="<?php echo site_url('assets/frontend/default-new/'); ?>image/smartphone.png" alt="">
                    <div class="h3-banner-card-1-text">
                        <h5>
                            <a href="#">
                        ...
                        <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($top_course['title'])) . '/' . $top_course['id']); ?>" id="top_course_<?php echo $top_course['id']; ?>" class="checkPropagation courses-card-body">
                            <div class="courses-card-image">
                                ...
                                <div class="courses-icon <?php if(in_array($top_course['id'], $my_wishlist_items)) echo 'red-heart'; ?>" id="coursesWishlistIconTopCourse<?php echo $top_course['id']; ?>">
                                    <p><i class="fa-solid fa-heart checkPropagation" onclick="actionTo('<?php echo site_url('home/toggleWishlistItems/'.$top_course['id'].'/TopCourse'); ?>')"></i></p>
                                </div>
                            ...
                            <div class="popover-btns">
                                ...
                                <?php if(is_purchased($top_course['id'])): ?>
                                    ...
                                    <?php if ($top_course['is_free_course'] != 1) : ?>
                                        <button type="button" class="gift-btn ms-auto" title="<?php echo get_phrase('Gift someone else'); ?>" data-bs-toggle="tooltip" onclick="actionTo('<?php echo site_url('home/handle_buy_now/' . $top_course['id']); ?>')"><i class="fas fa-gift"></i></button>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <?php if ($top_course['is_free_course'] == 1) : ?>
                            ...
                            <div class="popover-btns">
                                ...
                                <?php if(is_purchased($latest_course['id'])): ?>
                                    ...
                                    <?php if ($latest_course['is_free_course'] != 1) : ?>
                                        <button type="button" class="gift-btn ms-auto" title="<?php echo get_phrase('Gift someone else'); ?>" data-bs-toggle="tooltip" onclick="actionTo('<?php echo site_url('home/handle_buy_now/' . $latest_course['id']); ?>')"><i class="fas fa-gift"></i></button>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <?php if ($latest_course['is_free_course'] == 1) : ?>
...
<section class="h-3-expert-instructor h-3-courses">
    <div class="container">
        ...
        <div class="row instructor-slider owl-carousel owl-theme">
            <?php foreach($top_instructor_ids as $top_instructor_id):
                ...
                <div class="h-3-expart-1">
                    <img onclick="redirectTo('<?php echo site_url('home/instructor_page/'.$top_instructor['id']); ?>')" src="<?php echo $this->user_model->get_user_image_url($top_instructor['id']); ?>">
                        ...
                        <a href="<?php echo site_url('blog/details/'.slugify($latest_blog['title']).'/'.$latest_blog['blog_id']); ?>" class="h-3-blog-card-body">
                           <div class="scall-img">
                            <?php $blog_thumbnail = 'uploads/blog/thumbnail/'.$latest_blog['thumbnail'];
                              ...
                              <img src="<?php echo $blog_thumbnail; ?>" alt="" style="min-height: 200px;">
                            </div>
