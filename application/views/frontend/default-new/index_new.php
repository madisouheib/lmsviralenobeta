...
<html class="no-js" lang="zxx" dir="rtl">
   <head>
      ...
      <title>   المركز           الوطني للتدريب البحري </title>
      <meta name="description" content="">
      <meta name="viewport" content="width=device-width, initial-scale=1">
      <!-- Place favicon.ico in the root directory -->
      <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url() . 'assets/frontend/default-custom/img/logo.png'; ?>">
      <!-- CSS here -->
      ...
      <?php 
      	    	...
      	    	include 'custom/includes_top.php';
?>
      <style>
      .bg-white {
      ...
      .bg-overl {
          background:url('<?php echo base_url() . 'assets/frontend/default-custom/img/cargo.jpg'; ?>') ;
         ...
         <div id="loading-center">
            <div id="loading-center-absolute">
               <div class="loading-content">
                  <img class="loading-logo-text" src="<?php echo base_url() . 'assets/frontend/default-custom/img/logo.png'; ?>" alt="">
                  <div class="loading-stroke">
                     <img class="loading-logo-icon" src="<?php echo base_url() . 'assets/frontend/default-custom/img/logo.png'; ?>" alt="">
                  </div>
               </div>
            </div>
         </div>  
               ...
               <div class="row align-items-center">
                  <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-2 col-sm-4 col-6">
                     <div class="header__left d-flex">
                        <div class="logo">
                           <a href="/">
                              <img src="<?php echo base_url() . 'assets/frontend/default-custom/img/logo.png'; ?>" style="height: 95px;width: 255px;" alt="logo">
                           </a>
                        </div>
                  ...
                  <div class="col-xxl-9 col-xl-9 col-lg-8 col-md-10 col-sm-8 col-6">
                     <div class="header__right d-flex justify-content-end align-items-center">
                        ...
                        <div class="header__btn ml-20 d-none d-sm-block">
                           <a href="<?php echo base_url() .'login' ;?>" class="e-btn">
                              التسجيل و الدخول
                  ...
                  <ul>
                     <li>
                        <div class="cartmini__thumb">
                           <a href="#">
                              <img src="<?php echo base_url() . 'assets/frontend/default-custom/img/course/sm/cart-1.jpg'; ?> " alt="">
                           </a>
                        </div>
...
<div class="bg-overl" >
         ...
         <div class="sidebar__wrapper">
            ...
            <div class="sidebar__content">
               <div class="logo mb-40">
                  <a href="/">
                  <img src="<?php echo base_url() . 'assets/frontend/default-custom/img/img/logo/logo.png'; ?>" alt="logo">
                  </a>
               </div>
      ...
      <main>
         ...
         <!-- hero area start -->
         <section class="hero__area hero__height d-flex align-items-center   p-relative">
            <div class="hero__shape">

               <img class="hero-1-circle-2" src="<?php echo base_url() . 'assets/frontend/default-custom/img/shape/hero/hero-1-circle-2.png'; ?>" alt="">
               <img class="hero-1-dot-2" src="<?php echo base_url() . 'assets/frontend/default-custom/img/shape/hero/hero-1-dot-2.png'; ?>" alt="">
            </div>
            <div class="container">
                     ...
                     <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                        <div class="hero__content p-relative z-index-1">
                           <h3 class="hero__title">
                              <span></span>
                              <span class="yellow-shape">المركز
                                 <img src="<?php echo base_url() . 'assets/frontend/default-custom/img/shape/yellow-bg.png'; ?>" alt="yellow-shape">
                              
                               </span> 
                                الوطني للتدريب البحري
                              </h3>
                              <p>تعرف على الجامعات والمؤسسات الثقافية التي ستشارك خبراتها.</p>
                              <a href="#" class="e-btn">عرض كل الدورة</a>
                        </div>
                     </div>
                     <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                        <div class="hero__thumb d-flex p-relative">
                           <div class="hero__thumb-shape">
                              <img class="hero-1-dot" src="<?php echo base_url() . 'assets/frontend/default-custom/img/shape/hero/hero-1-dot.png'; ?>" alt="">
                              <img class="hero-1-circle-3" src="<?php echo base_url() . 'assets/frontend/default-custom/img/shape/hero/hero-1-circle-3.png'; ?>" alt="">
                              <img class="hero-1-circle-4" src="<?php echo base_url() . 'assets/frontend/default-custom/img/shape/hero/EllipseBlue.svg'; ?>" alt="">
                           </div>
                           <div class="hero__thumb-big mr-30">
                              <img src="<?php echo base_url() . 'assets/frontend/default-custom/img/logo/logo.pngassets/img/hero/homepage.png'; ?>" alt="">
                              <div class="hero__quote hero__quote-animation">
                                 <span> شارك معنا</span>
                                 <h4>“ و كن قبطان يفينتك</h4>
                              </div>
                           </div>
                           <div class="hero__thumb-sm mt-50 d-none d-lg-block">
                              <img src="<?php echo base_url() . 'assets/frontend/default-custom/img/hero/small-hero.png'; ?>" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <!-- category area start -->
         <section class="category__area pt-120 pb-70 grey-bg-2">
            <div class="container">
               <div class="row align-items-end">
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-8">
                     <div class="section__title-wrapper mb-45">
                        <h2 class="section__title">اكتشف <br>معنا <span class="yellow-bg">جميع <img src="<?php echo base_url() . 'assets/frontend/default-custom/img/shape/yellow-bg-2.png'; ?>" alt="">  </span>الدورات
                        </h2>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="course-details.html">علم البيانات</a></h4>
                           <p>البيانات هي كل شيء</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="#">اعمال</a></h4>
                           <p>تحسين عملك</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="course-details.html">تصميم فني</a></h4>
                           <p>المرح والتحدي</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="course-details.html">أسلوب الحياة</a></h4>
                           <p>مهارات جديدة ، أنت جديد</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="course-details.html">تسويق</a></h4>
                           <p>تحسين عملك</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="course-details.html">تمويل</a></h4>
                           <p>المرح والتحدي</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="course-details.html">الصحة واللياقة البدنية</a></h4>
                           <p>استثمر في جسمك</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="#de">موسيقى</a></h4>
                           <p>رئيسي أو ثانوي</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="course-details.html">أكاديميون</a></h4>
                           <p>مستوى تعليمي عالي</p>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <!-- banner area start -->
         <section class="banner__area pb-110 grey-bg-2">
            <div class="container">
               <div class="row">
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                     <div class="banner__item p-relative mb-40" data-background="<?php echo base_url() . 'assets/frontend/default-custom/img/banner/banner-bg-1.jpg'; ?>">
                        <div class="banner__content">
                           <span>متدرب حر</span>
                           <h3 class="banner__title">
                              <a href="#"> التسجيل <br> كمتدرب حر </a>
                           </h3>
                           <a href="#" class="e-btn e-btn-2"> التسجيل</a>
                        </div>
                        <div class="banner__thumb d-none d-sm-block d-md-none d-lg-block">
                           <img style="height: 215px;width: 332px;" src="<?php echo base_url() . 'assets/frontend/default-custom/img/trainer.svg'; ?>" alt="">
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                     <div class="banner__item p-relative mb-40" data-background="<?php echo base_url() . 'assets/frontend/default-custom/img/banner/banner-bg-2.jpg'; ?>">
                        <div class="banner__content">
                           <span class="orange">شركة خاصة</span>
                           <h3 class="banner__title">
                              <a href="#"> التسجيل  <br> كشركة خاصة </a>
                           </h3>
                           <a href="#" class="e-btn e-btn-2"> التسجيل</a>
                        </div>
                        <div class="banner__thumb banner__thumb-2 d-none d-sm-block d-md-none d-lg-block">
                           <img style="height: 276px;width: 332px;" src="<?php echo base_url() . 'assets/frontend/default-custom/img/charikaLogin.svg'; ?>" alt="">
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col-xxl-5 col-xl-6 col-lg-6">
                     <div class="section__title-wrapper mb-60">
                        <h2 class="section__title">
                           ...
                           <span class="yellow-bg yellow-bg-big">الدورات<img src="<?php echo base_url() . 'assets/frontend/default-custom/img/shape/yellow-bg.png'; ?>" alt=""></span> for you</h2>
                        <p>
أغلب الدورات و احدثها                        
                        </p>
                     </div>
                  </div>
                  <div class="col-xxl-7 col-xl-6 col-lg-6">
                     <div class="course__menu d-flex justify-content-lg-end mb-60">
                        <div class="masonary-menu filter-button-group">
                           ...
                           <button data-filter=".cat2"> </button>
                           <button data-filter=".cat3"> </button>
                           <button data-filter=".cat4"> </button>
                       </div>
                     </div>
                  </div>
               </div>
...
<!---------- Latest courses Section End --------------->
                     ...
                     <div class="course__item white-bg mb-30 fix">
                        <div class="course__thumb w-img p-relative fix">
                           ...
                           <div class="course__tag">
                              <a href="#" class="pink"> <?php echo $course['title']; ?> </a>
                           </div>
                        </div>
                        <div class="course__content">
                           <div class="course__meta d-flex align-items-center justify-content-between">
                              <div class="course__lesson">
                                 <span><i class="far fa-book-alt"></i> درس <?php echo $course_duration; ?> </span>
                              </div>
                              <div class="course__rating">
                                 <span><i class="icon_star"></i>(<?php echo $number_of_ratings; ?> <?php echo get_phrase('Reviews') ?>)</span>
                              </div>
                           </div>
                           <h3 class="course__title"><a href="<?php echo site_url('home/course/' . rawurlencode(slugify($course['title'])) . '/' . $course['id']); ?>">وصف الدورة</a></h3>
                           <div class="course__teacher d-flex align-items-center">
                              <div class="course__teacher-thumb mr-15">
                                 <img src="<?php echo base_url() . 'assets/frontend/default-custom/img/course/teacher/teacher-6.jpg'; ?>" alt="">
                              </div>
                              <h6><a href=""> اسم المدرب</a></h6>
                           </div>
                        </div>
                        <div class="course__more d-flex justify-content-between align-items-center">
                           <div class="course__status d-flex align-items-center">
                                      <?php if($course['is_free_course']): ?>
                                        <span class="old-price">  <?php echo get_phrase('Free'); ?></span>
                                            
                                                       <?php elseif($course['discount_flag']): ?>
                                                       
                                                       
                                                       
                              <span class="pink"><?php echo currency($course['discounted_price']); ?></span>
                              <span class="old-price"><?php echo currency($course['price']); ?></span>
                              
                                  <?php else: ?>
                                          <span class="pink"><?php echo currency($course['price']); ?></span>
                                      <?php endif; ?>
                           </div>
                           <div class="course__btn">
                              <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($course['title'])) . '/' . $course['id']); ?>" class="link-btn">
                                 مزيد من التفاصيل
                                 <i class="far fa-arrow-right"></i>
                                 <i class="far fa-arrow-right"></i>
                              </a>
                     ...
                     <div class="course__item white-bg mb-30 fix">
                        <div class="course__thumb w-img p-relative fix">
                           <a href="course-details.html">
                              <img src="<?php echo base_url() . 'assets/frontend/default-custom/img/course/course-6.jpg'; ?>" alt="">
                           </a>
                           <div class="course__tag">
                              <a href="#" class="pink"> اسم الدورة</a>
                           </div>
                        </div>
                        <div class="course__content">
                           <div class="course__meta d-flex align-items-center justify-content-between">
                              <div class="course__lesson">
                                 <span><i class="far fa-book-alt"></i>13 درس</span>
                              </div>
                              <div class="course__rating">
                                 <span><i class="icon_star"></i>4.5 (72)</span>
                              </div>
                           </div>
                           <h3 class="course__title"><a href="course-details.html">وصف الدورة</a></h3>
                           <div class="course__teacher d-flex align-items-center">
                              <div class="course__teacher-thumb mr-15">
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat2 cat3">
                     <div class="course__item white-bg mb-30 fix">
                        ...
                        <div class="course__content">
                           ...
                           <h3 class="course__title"><a href="">وصف الدورة</a></h3>
                           <div class="course__teacher d-flex align-items-center">
                              <div class="course__teacher-thumb mr-15">
                                 <img src="assets/img/course/teacher/teacher-6.jpg" alt="">
                              </div>
         ...
         <!-- events area start -->
         <section class="events__area pt-115 pb-120 p-relative bg-white">
               ...
               <div class="row">
                  <div class="col-xxl-4 offset-xxl-4">
                     <div class="section__title-wrapper mb-60 text-center">
                        <h2 class="section__title"> الحصص <span class="yellow-bg yellow-bg-big"> الاسبوعية <img src="assets/img/shape/yellow-bg.png" alt=""></span></h2>
                        <p> مجموعة من الحصص المبرمجة هذا الاسبوع.</p>
                     </div>
                  </div>
               </div>
               <div class="row">
                        ...
                        <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                           <div class="events__content">
                              <div class="events__meta">
                                 ...
                                 <span> اسم الحصة المبرمجة</span>
                              </div>
                              <h3 class="events__title"><a href=""> وصف الحصة المبرمجة </a></h3>
                           </div>
         ...
         <!-- pricing area start -->
         <section class="price__area pt-60 pb-130 grey-bg-2">
            <div class="container">
               <div class="row">
                  <div class="col-xxl-4 offset-xxl-4">
                     <div class="section__title-wrapper mb-60 text-center">
                        <h2 class="section__title"> الان<br> مجموعة من  الدورات  <span class="yellow-bg yellow-bg-big">الحصرية<img src="assets/img/shape/yellow-bg.png" alt=""></span></h2>
                        <p>باشتراك شهري او سنوي.</p>
                     </div>
                  </div>
               </div>
               <div class="row">
                              ...
                              <div class="row">
                                 <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                    <div class="price__item grey-bg mb-30 p-relative">
                                       <div class="price__head">
                                          <h3>الذهبية</h3>
                                          <p> وصف للباقة المطلوبة</p>
                                       </div>
                                       <div class="price__tag mb-25">
                                          <h4>$59<span>.99 / شهريا</span></h4>
                                       </div>
                                       <div class="price__features mb-40">
                                          <ul>
                                             <li><i class="far fa-check"></i>خاصية الباقة</li>
                                             <li><i class="far fa-check"></i>خاصية الباقة</li>
                                             <li><i class="far fa-check"></i>خاصية الباقة</li>
                                          </ul>
                                       </div>
                                       <a href="contact.html" class="e-btn e-btn-4"> تفعيل الباقة</a>
                                    </div>
                                 </div>
                                 <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                    <div class="price__item grey-bg mb-30 p-relative">
                  ...
                  <div class="container">
                     <div class="row">
                           ...
                           <div class="footer__widget mb-50">
                              <div class="footer__widget-head mb-22">
                                 <div class="footer__logo">
                                    <a href="index.html">
                                       <img src="assets/img/logo.png" height="100px" width="230" alt="">
                                    </a>
                                 </div>
                              </div>
                              <div class="footer__widget-body">
                                 <p>
                                    الوطني للتدريب البحري المركز 
                        ...
                        <div class="col-xxl-2 offset-xxl-1 col-xl-2 offset-xl-1 col-lg-3 offset-lg-0 col-md-2 offset-md-1 col-sm-5 offset-sm-1">
                           <div class="footer__widget mb-50">
                              <div class="footer__widget-head mb-22">
                                 <h3 class="footer__widget-title">  الوطني للتدريب البحري المركز  </h3>
                              </div>
                              <div class="footer__widget-body">
                        ...
                        <div class="col-xxl-2 col-xl-2 col-lg-2 offset-lg-0 col-md-3 offset-md-1 col-sm-6">
                           <div class="footer__widget mb-50">
                              <div class="footer__widget-head mb-22">
                                 <h3 class="footer__widget-title"> المنصة </h3>
                              </div>
                              <div class="footer__widget-body">
                                 <div class="footer__link">
                                    <ul>
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-5 col-sm-6">
                           <div class="footer__widget footer__pl-70 mb-50">
                              <div class="footer__widget-head mb-22">
                                 <h3 class="footer__widget-title">المشاركة</h3>
                              </div>
                              <div class="footer__widget-body">
                     ...
                     <div class="row">
                        <div class="col-xxl-12">
                           <div class="footer__copyright text-center">
                              <p>© 2023 , All Rights Reserved. Design By <a href="index.html">  COMPANY </a></p>
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <!-- JS here -->
            ...
            <?php 
      	    	...
      	    	include 'custom/includes_bottom.php';
?>
