                                ...
                                <div class="my-course-1-full-body-card">
                                    ...
                                    <div class="my-course-1-text pt-1">
                                        <div class="my-course-1-text-heading">
                                            <h3 style="margin-right:10px;"><?php echo $course_details['title']; ?></h3>
                                        ...
                                        <div class="my-course-1-skill">
                                              <div class="skill-bar-container" style="margin-right:5px">
                                        ...
                                        <div class="my-course-1-last">
                                            <div class="icon-img d-grid" style="margin-right:5px;">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="star m-0" style="margin-right:15px;">
                                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                                ...
                                                <?php if($enrolment['expiry_date'] > 0 && $enrolment['expiry_date'] < time()): ?>
                                                    <span class="text-12px text-end mt-2"><?php echo get_phrase('Expired') ?> - <b style="color: var(--bs-code-color);"><?php echo date('d M Y, H:i A', $enrolment['expiry_date']); ?></b></span>
                                                <?php else: ?>
                                                    <?php if($enrolment['expiry_date'] == 0): ?>
                                                        <span class="text-12px text-end mt-2"><?php echo get_phrase('Expiry period') ?> - <b class="text-success text-uppercase"><?php echo get_phrase('Lifetime Access'); ?></b></span>
                                                    <?php else: ?>
                                                        <span class="text-12px text-end mt-2"><?php echo get_phrase('Expiration On') ?> - <b><?php echo date('d M Y, H:i A', $enrolment['expiry_date']); ?></b></span>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </div>
