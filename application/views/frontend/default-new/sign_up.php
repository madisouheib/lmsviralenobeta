...
<!---------- Header Section End  ---------->
<section class="sign-up  " style="padding-top: 6em;">
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12 col-12 text-center">
                <img width="65%" src="<?php echo site_url('assets/frontend/default-new/image/sgp.gif') ?>">
            </div>
                    ...
                    <form action="<?php echo site_url('login/register') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <?php if(get_settings('allow_instructor')): ?>
                            <div class="mb-4">
                                ...
                                <label for="instructor"><?php echo get_phrase('Apply to become a instructor'); ?></label>
                            </div>
